...
<div class="ml-16">
       ...
       >
         ...
         <!-- Wizard form steps -->
         <form @submit.prevent="submitForm" id="addjobformwizard">
           <!-- Step 1: Basic Info -->
           <div x-show="currentStep === 1">
             ...
             <div class="flex space-x-4">
               <div class="flex-1">
                 ...
                 >
                 <select
                   x-ref="jobLaborCategory"
                   x-model="formData.jobLaborCategory"
                   class="w-full select2-single custom-style"
                   data-field="jobLaborCategory"
                   id="jobLaborCategory"
                 >
                 ...
                 <p
                   ...
                   x-text="getErrorMessageById('jobLaborCategory')"
                 ></p>
               </div>
               <div class="flex-1">
                 <label class="block mb-2"
                 ...
                 <p
                   ...
                   class="text-red-500 text-sm mt-1"
                   x-text="getErrorMessageById('jobTitle')"
                 ></p>
               </div>
               <div class="flex-1">
             ...
             <div class="flex space-x-4 mt-4">
               <div class="flex-1">
                 <label for="jobTitleEmailSignature" class="block mb-2"
                   >Job Title for Email Signature</label
                 >
                 <div class="relative">
                   <input
                     type="text"
                     id="jobTitleEmailSignature"
               ...
               <div class="flex-1">
                 ...
                 <p
                   ...
                   class="text-red-500 text-sm mt-1"
                   x-text="getErrorMessageById('hiringManager')"
                 ></p>
               </div>
               <div class="flex-1">
                 <label class="block mb-2"
                   >Job Level <span class="text-red-500">*</span></label
                 >
                 <select
                   x-ref="jobLevel"
                   x-model="formData.jobLevel"
                   class="w-full select2-single custom-style"
                   data-field="jobLevel"
                   id="jobLevel"
                 >
                 ...
                 <p
                   ...
                   class="text-red-500 text-sm mt-1"
                   x-text="getErrorMessageById('jobLevel')"
                 ></p>
               </div>
             </div>
             ...
             <div class="flex space-x-4 mt-4">
               ...
               <div class="flex-1">
                 ...
                 <p
                   ...
                   class="text-red-500 text-sm mt-1"
                   x-text="getErrorMessageById('currency')"
                 ></p>
               </div>
               <div class="flex-1">
                 <label class="block mb-2">
                 ...
                 <div class="relative">
                   ...
                   <p
                     x-show="showErrors && !isFieldValid('billRate')"
                     class="text-red-500 text-sm mt-1"
                     x-text="getErrorMessageById('billRate')"
                   ></p>
                 </div>
               </div>
             </div>
             ...
             <div class="flex space-x-4 mt-4">
               <div class="flex-1">
                 ...
                 <div class="relative">
                   ...
                   <p
                     x-show="showErrors && !isFieldValid('maxBillRate')"
                     class="text-red-500 text-sm mt-1"
                     x-text="getErrorMessageById('maxBillRate')"
                   ></p>
                 </div>
               </div>
           ...
           <div x-show="currentStep === 2">
             ...
             <div class="flex space-x-4">
               <div class="flex-1">
                 ...
                 <select
                   x-ref="preIdentifiedCandidate"
                   x-model="formData.preIdentifiedCandidate"
                   class="w-full select2-single custom-style"
                   data-field="preIdentifiedCandidate"
                   id="preIdentifiedCandidate"
                 >
                 ...
                 <p
                   x-show="showErrors && !isFieldValid('preIdentifiedCandidate')"
                   class="text-red-500 text-sm mt-1"
                   x-text="getErrorMessageById('preIdentifiedCandidate')"
                 ></p>
               </div>
               <div class="flex-1"></div>
               <div class="flex-1"></div>
             ...
             <div
               x-show="formData.preIdentifiedCandidate === 'yes'"
               class="mt-4"
             >
               ...
               <div class="flex space-x-4 mb-4">
                 <div class="flex-1">
                   ...
                   <input
                     type="tel"
                     x-model="formData.candidatePhone"
                   ...
                   />
                   <p
                     x-show="showErrors && !isFieldValid('candidatePhone')"
                     class="text-red-500 text-sm mt-1"
                     x-text="getErrorMessageById('candidatePhone')"
                   ></p>
                 </div>
                 <div class="flex-1">
                   <label class="block mb-2"
                 ...
                 <div class="flex-1">
                   ...
                   <div class="relative">
                     ...
                     <input
                       type="text"
                       x-model="formData.workerPayRate"
                   ...
                   <p
                     x-show="showErrors && !isFieldValid('workerPayRate')"
                     class="text-red-500 text-sm mt-1"
                     x-text="getErrorMessageById('workerPayRate')"
                   ></p>
                 </div>
               </div>
               <div class="flex mb-4">
                 <div class="w-1/3">
                   ...
                   >
                   <select
                     x-model="formData.engageWorkerAs"
                     class="w-full select2-single custom-style"
                     data-field="engageWorkerAs"
                     id="engageWorkerAs"
                   >
                   ...
                   <p
                     x-show="showErrors && !isFieldValid('engageWorkerAs')"
                     class="text-red-500 text-sm mt-1"
                     x-text="getErrorMessageById('engageWorkerAs')"
                   ></p>
                 </div>
               </div>
             </div>
             ...
             >
               <div class="flex-1">
                 <label class="block mb-2"
                   >Labor Type <span class="text-red-500">*</span></label
                 >
                 <select
                   x-ref="laborType"
                   x-model="formData.laborType"
                   class="w-full select2-single custom-style"
                   data-field="laborType"
                   id="laborType"
                 >
                   <option value="">Select a category</option>
                   <option value="javascript">JavaScript</option>
                 ...
                 <p
                   ...
                   class="text-red-500 text-sm mt-1"
                   x-text="getErrorMessageById('laborType')"
                 ></p>
               </div>
               <div class="flex-1">
                 ...
                 />
                 <p
                   x-show="showErrors && !isFieldValid('startDate')"
                   class="text-red-500 text-sm mt-1"
                   x-text="getErrorMessageById('startDate')"
                 ></p>
               </div>
               <div class="flex-1">
                 <label for="endDate" class="block mb-2"
                   >Choose End Date: <span class="text-red-500">*</span></label
                 >
                 <input
                   id="endDate"
                   class="w-full h-12 px-4 text-gray-500 border border-gray-300 rounded-md shadow-sm focus:outline-none pl-7"
                 ...
                 />
                 <p
                   x-show="showErrors && !isFieldValid('endDate')"
                   class="text-red-500 text-sm mt-1"
                   x-text="getErrorMessageById('endDate')"
                 ></p>
               </div>
             </div>
             ...
             <div class="mt-4">
               ...
               <p
                 x-show="showErrors && !isFieldValid('jobDescriptionEditor')"
                 class="text-red-500 text-sm mt-1"
                 x-text="getErrorMessageById('jobDescriptionEditor')"
               ></p>
             </div>
             ...
             <div class="mt-4">
               ...
               <p
                 x-show="showErrors && !isFieldValid('qualificationSkillsEditor')"
                 class="text-red-500 text-sm mt-1"
                 x-text="getErrorMessageById('qualificationSkillsEditor')"
               ></p>
             </div>
             ...
             <div class="mt-4">
               ...
               >
               <div
                 id="additionalRequirementEditor"
                 style="height: 300px"
               ></div>
               <p
                 x-show="showErrors && !isFieldValid('additionalRequirementEditor')"
                 class="text-red-500 text-sm mt-1"
                 x-text="getErrorMessageById('additionalRequirementEditor')"
               ></p>
             </div>
           ...
           <div x-show="currentStep === 3">
             ...
             <div class="mb-6">
               <div class="flex space-x-4 mb-4">
                 <div class="flex-1">
                   <label class="block mb-2"
                     >Business Unit <span class="text-red-500">*</span></label
                   >
                   <select
                     x-ref="businessUnitSelect"
               ...
               <p
                 x-show="showErrors && !isBusinessUnitValid"
                 class="text-red-500 text-sm mt-1"
               >
               ...
               <table class="w-full mt-4 border-collapse">
                 ...
                 <tbody>
                   <template
                     x-for="(bu, index) in formData.businessUnits"
                     :key="index"
                   >
                     <tr class="border-b border-gray-200">
                       ...
                       <td class="py-2 px-3 text-center">
                         <button
                           @click="removeBusinessUnit(index)"
                           type="button"
             ...
             <div class="flex space-x-4 mb-4">
               <div class="flex-1">
                 ...
                 <p
                   ...
                   class="text-red-500 text-sm mt-1"
                   x-text="getErrorMessageById('division')"
                 ></p>
               </div>
               <div class="flex-1">
                 <label class="block mb-2"
                   >Region/Zone <span class="text-red-500">*</span></label
                 >
                 <select
                   x-model="formData.regionZone"
                   class="w-full select2-single custom-style"
                   data-field="regionZone"
                   id="regionZone"
                 >
                 ...
                 <p
                   ...
                   class="text-red-500 text-sm mt-1"
                   x-text="getErrorMessageById('regionZone')"
                 ></p>
               </div>
               <div class="flex-1">
                 <label class="block mb-2"
                 ...
                 <p
                   ...
                   class="text-red-500 text-sm mt-1"
                   x-text="getErrorMessageById('branch')"
                 ></p>
               </div>
             </div>
             ...
             <div class="flex space-x-4 mb-4">
               <div class="flex-1">
                 ...
                 >
                 <select
                   x-model="formData.expensesAllowed"
                   class="w-full select2-single custom-style"
                   data-field="expensesAllowed"
                   id="expensesAllowed"
                 >
                   <option value="">Select</option>
                   <option value="yes">Yes</option>
                 ...
                 <p
                   x-show="showErrors && !isFieldValid('expensesAllowed')"
                   class="text-red-500 text-sm mt-1"
                   x-text="getErrorMessageById('expensesAllowed')"
                 ></p>
               </div>
               <div class="flex-1">
                 <label class="block mb-2"
                   >Travel Required? <span class="text-red-500">*</span></label
                 >
                 <select
                   x-model="formData.travelRequired"
                   class="w-full select2-single custom-style"
                   data-field="travelRequired"
                   id="travelRequired"
                 >
                   <option value="">Select</option>
                   <option value="yes">Yes</option>
                 ...
                 <p
                   x-show="showErrors && !isFieldValid('travelRequired')"
                   class="text-red-500 text-sm mt-1"
                   x-text="getErrorMessageById('travelRequired')"
                 ></p>
               </div>
               <div class="flex-1">
                 <label class="block mb-2"
                   >GL Code <span class="text-red-500">*</span></label
                 >
                 <select
                   x-model="formData.glCode"
                   class="w-full select2-single custom-style"
                   data-field="glCode"
                   id="glCode"
                 >
                 ...
                 <p
                   ...
                   class="text-red-500 text-sm mt-1"
                   x-text="getErrorMessageById('glCode')"
                 ></p>
               </div>
             </div>
             ...
             <div class="flex space-x-4 mb-4">
               <div class="flex-1">
                 <label class="block mb-2"
                   >Client Billable? <span class="text-red-500">*</span></label
                 >
                 <select
                   x-model="formData.clientBillable"
                   class="w-full select2-single custom-style"
                   data-field="clientBillable"
                   id="clientBillable"
                 >
                   <option value="">Select</option>
                   <option value="yes">Yes</option>
                 ...
                 <p
                   x-show="showErrors && !isFieldValid('clientBillable')"
                   class="text-red-500 text-sm mt-1"
                   x-text="getErrorMessageById('clientBillable')"
                 ></p>
               </div>
               <div class="flex-1">
                 <label class="block mb-2"
                 ...
                 >
                 <select
                   x-model="formData.requireOT"
                   class="w-full select2-single custom-style"
                   data-field="requireOT"
                   id="requireOT"
                 >
                   <option value="">Select</option>
                   <option value="yes">Yes</option>
                 ...
                 <p
                   x-show="showErrors && !isFieldValid('requireOT')"
                   class="text-red-500 text-sm mt-1"
                   x-text="getErrorMessageById('requireOT')"
                 ></p>
               </div>
               <div class="flex-1">
                 <label class="block mb-2"
                 ...
                 >
                 <select
                   x-model="formData.virtualRemote"
                   class="w-full select2-single custom-style"
                   data-field="virtualRemote"
                   id="virtualRemote"
                 >
                   <option value="">Select</option>
                   <option value="yes">Yes</option>
                 ...
                 <p
                   x-show="showErrors && !isFieldValid('virtualRemote')"
                   class="text-red-500 text-sm mt-1"
                   x-text="getErrorMessageById('virtualRemote')"
                 ></p>
               </div>
             </div>
             ...
             >
               <div class="flex-1" x-show="formData.clientBillable === 'yes'">
                 ...
                 />
                 <p
                   x-show="showErrors && !isFieldValid('clientName')"
                   class="text-red-500 text-sm mt-1"
                   x-text="getErrorMessageById('clientName')"
                 ></p>
               </div>
               <div class="flex-1" x-show="formData.expensesAllowed === 'yes'">
                 ...
                 <div class="relative">
                   ...
                   <input
                     type="text"
                     x-model="formData.estimatedExpense"
                 ...
                 <p
                   x-show="showErrors && !isFieldValid('estimatedExpense')"
                   class="text-red-500 text-sm mt-1"
                   x-text="getErrorMessageById('estimatedExpense')"
                 ></p>
               </div>
               <div class="flex-1"></div>
             </div>
           ...
           <div x-show="currentStep === 4">
             ...
             <div class="flex space-x-4 mb-4">
               <div class="flex-1">
                 <label class="block mb-2"
                   >Unit of Measure <span class="text-red-500">*</span></label
                 >
                 <select
                   x-model="formData.unitOfMeasure"
                   class="w-full select2-single custom-style"
                 ...
                 <p
                   x-show="showErrors && !isFieldValid('unitOfMeasure')"
                   class="text-red-500 text-sm mt-1"
                   x-text="getErrorMessageById('unitOfMeasure')"
                 ></p>
               </div>
               <div class="flex-1">
                 <label class="block mb-2"
                   >Time Type <span class="text-red-500">*</span></label
                 >
                 <select
                   x-model="formData.timeType"
                   class="w-full select2-single custom-style"
                   data-field="timeType"
                   id="timeType"
                 >
                 ...
                 <p
                   x-show="showErrors && !isFieldValid('timeType')"
                   class="text-red-500 text-sm mt-1"
                   x-text="getErrorMessageById('timeType')"
                 ></p>
               </div>
               <div class="flex-1">
                 <label class="block mb-2"
                 ...
                 <input
                   type="number"
                   x-model="formData.estimatedHoursPerDay"
                   class="w-full h-12 px-4 text-gray-500 border border-gray-300 rounded-md shadow-sm focus:outline-none"
                   min="0"
                   step="0.5"
                 />
                 <p
                   x-show="showErrors && !isFieldValid('estimatedHoursPerDay')"
                   class="text-red-500 text-sm mt-1"
                   x-text="getErrorMessageById('estimatedHoursPerDay')"
                 ></p>
               </div>
             </div>
             ...
             <div class="flex space-x-4 mb-4">
               <div class="flex-1">
                 <label class="block mb-2"
                   >Work Days / Week <span class="text-red-500">*</span></label
                 >
                 <input
                   type="number"
                   x-model="formData.workDaysPerWeek"
                   class="w-full h-12 px-4 text-gray-500 border border-gray-300 rounded-md shadow-sm focus:outline-none"
                   min="1"
                   max="7"
                   id="workDaysPerWeek"
                 />
                 <p
                   x-show="showErrors && !isFieldValid('workDaysPerWeek')"
                   class="text-red-500 text-sm mt-1"
                   x-text="getErrorMessageById('workDaysPerWeek')"
                 ></p>
               </div>
               <div class="flex-1">
                 <label class="block mb-2"
                 ...
                 <input
                   type="number"
                   x-model="formData.numberOfPositions"
                   class="w-full h-12 px-4 text-gray-500 border border-gray-300 rounded-md shadow-sm focus:outline-none"
                   min="1"
                 />
                 <p
                   x-show="showErrors && !isFieldValid('numberOfPositions')"
                   class="text-red-500 text-sm mt-1"
                   x-text="getErrorMessageById('numberOfPositions')"
                 ></p>
               </div>
               <div class="flex-1">
                 <label class="block mb-2"
                   >Business Reason <span class="text-red-500">*</span></label
                 >
                 <select
                   x-model="formData.businessReason"
                   class="w-full select2-single custom-style"
                   data-field="businessReason"
                 >
                   <option value="">Select Business Reason</option>
                   <option value="perDay">Add - Budgeted</option>
                   <option value="perDay">Add - Non-Budgeted</option>
                 </select>
                 <p
                   x-show="showErrors && !isFieldValid('businessReason')"
                   class="text-red-500 text-sm mt-1"
                   x-text="getErrorMessageById('businessReason')"
                 ></p>
               </div>
             </div>
             ...
             <div class="flex space-x-4 mb-4">
               ...
               <div class="flex-1">
                 ...
                 <div class="relative">
                   ...
                   <input
                     type="text"
                     x-model="formData.singleResourceCost"
                     class="w-full h-12 px-4 text-gray-500 border border-gray-300 rounded-md shadow-sm focus:outline-none pl-7"
                     disabled
                   />
                 </div>
               ...
               <div class="flex-1">
                 ...
                 <div class="relative">
                   ...
                   <input
                     type="text"
                     x-model="formData.allResourcesRegularCost"
                     class="w-full h-12 px-4 text-gray-500 border border-gray-300 rounded-md shadow-sm focus:outline-none pl-7"
                     disabled
                   />
                 </div>
             ...
             <div class="flex space-x-4 mb-4">
               <div class="flex-1">
                 ...
                 <div class="relative">
                   ...
                   <input
                     type="text"
                     x-model="formData.allResourcesCost"
                     class="w-full h-12 px-4 text-gray-500 border border-gray-300 rounded-md shadow-sm focus:outline-none pl-7"
                     disabled
                   />
                 </div>
               ...
               <div class="flex-1">
                 ...
                 <input
                   type="text"
                   x-model="formData.numberOfWeeks"
                   class="w-full h-12 px-4 text-gray-500 border border-gray-300 rounded-md shadow-sm focus:outline-none"
                   value="0 Weeks 1 Days"
                   disabled
                 />
               </div>
             </div>
             ...
             <div class="mb-4">
               <label
                 class="block mb-2"
                 :class="{'text-red-500': showErrors && !formData.termsAccepted}"
               >
                 <input
                   id="termsAccepted"
                   type="checkbox"
               ...
               <p
                 x-show="showErrors && !isFieldValid('termsAccepted')"
                 class="text-red-500 text-sm mt-1"
                 x-text="getErrorMessageById('termsAccepted')"
               ></p>
             </div>
           </div>
           <!-- Navigation buttons -->
