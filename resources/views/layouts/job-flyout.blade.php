...
<script>
    ...
    function displayJobDetails(job) {
            const flyoutComponent = document.querySelector('[x-data]');
            if (flyoutComponent && job) {
                console.log('Flyout Component:', flyoutComponent);
                console.log('Alpine Instance:', flyoutComponent.__x);

                if (flyoutComponent.__x) {
                    flyoutComponent.__x.selectedUser = {
                        id: job.id,
                        title: job.title,
                    ...
                    console.error('Alpine.js is not initialized');
                }
            } else {
                console.error('Flyout component or job data is missing');
            }
        }
</script>
