            ...
            <div class="container mx-auto p-4">
                <div class="flex flex-wrap mb-4">
                    <div class="w-1/2 pr-2">
                        <label for="contract_id" class="block mb-2">{{translate('Contractor')}} <span class="text-red-500">*</span></label>
                        <select id="contract_id" name="contract_id" class="w-full p-2 border rounded h-10 bg-white"
                            x-model="formData.contract_id">
                            <option value="" disabled>{{translate('Select Contractor')}}</option>
