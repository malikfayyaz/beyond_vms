            ...
            <div class="flex w-full gap-4">
                ...
                >
                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="flex items-center justify-between py-4 border-t">
                            ...
                            <div class="w-2/4">
                                <p class="font-light">
                                    <a href="{{ route('vendor.career-opportunities.show', $contract->career_opportunity_id) }}" class="text-blue-500">
                ...
                >
                    ...
                    <h3 class="flex items-center gap-2 my-4">
                        ...
                        ></i
                        ><span :style="{'color': 'var(--primary-color)'}">
                                <a href="{{ route('vendor.workorder.show', $contract->workorder_id) }}" class="text-blue-500">
                                    WorkOrder
                                            ({{ $contract->careerOpportunity->id }})
                                        </a>
                            </span>
                    ...
                    <h3 class="flex items-center gap-2 my-4">
                        ...
                        ></i
                        ><span :style="{'color': 'var(--primary-color)'}"
                        ><a href="{{ route('vendor.offer.show', $contract->offer_id) }}" class="text-blue-500">
                                   Offer
                                    ({{ $contract->offer_id }})
                                </a></span>
                    </h3>
