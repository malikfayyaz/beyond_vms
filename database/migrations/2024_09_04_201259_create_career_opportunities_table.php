...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('career_opportunities', function (Blueprint $table) {
            ...
            $table->string('job_po_duration', 55)->nullable();
            $table->string('job_po_duration_endDate', 25)->nullable();
            ...
            $table->integer('hire_type')->nullable()->default(0);
            ...
            $table->enum('previous_se_employee', ['Yes', 'No'])->default('No');
