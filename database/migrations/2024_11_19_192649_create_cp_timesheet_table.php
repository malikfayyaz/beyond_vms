...
class CreateCpTimesheetTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('cp_timesheets', function (Blueprint $table) {
            ...
            $table->decimal('total_regular_hours', 10, 2)->nullable()->default(0);
            $table->decimal('total_overtime_hours', 10, 2)->nullable()->default(0);
            $table->decimal('total_doubletime_hours', 10, 2)->nullable()->default(0);
            $table->decimal('total_hours', 10, 2)->nullable()->default(0);
            $table->decimal('marking_billrate', 10, 2)->nullable()->default(0);
            $table->decimal('marking_vendor_billrate', 10, 2)->nullable()->default(0);
            $table->decimal('marking_payrate', 10, 2)->nullable()->default(0);
            $table->decimal('new_total_hours', 10, 2)->nullable()->default(0);
            $table->decimal('total_100scale_regular_hours', 10, 2)->nullable()->default(0);
            $table->decimal('total_100scale_overtime_hours', 10, 2)->nullable()->default(0);
            $table->decimal('total_100scale_doubletime_hours', 10, 2)->nullable()->default(0);
            $table->decimal('total_100scale_hours', 10, 2)->nullable()->default(0);
            $table->decimal('new_100scale_total_hours', 10, 2)->nullable()->default(0);
            $table->decimal('leave_total_hours', 10, 2)->nullable()->default(0);
            $table->decimal('regular_payrate', 10, 2)->nullable()->default(0);
            $table->decimal('total_regular_payrate', 10, 2)->nullable()->default(0);
            $table->decimal('overtime_payrate', 10, 2)->nullable()->default(0);
            $table->decimal('total_overtime_payrate', 10, 2)->nullable()->default(0);
            $table->decimal('doubletime_payrate', 10, 2)->nullable()->default(0);
            $table->decimal('total_doubletime_payrate', 10, 2)->nullable()->default(0);
            $table->decimal('total_payrate', 10, 2)->nullable()->default(0);
            $table->decimal('new_total_payrate', 10, 2)->nullable()->default(0);
            $table->text('notes')->nullable();
            $table->decimal('regular_billrate', 10, 2)->nullable()->default(0);
            $table->decimal('total_regular_billrate', 10, 2)->nullable()->default(0);
            $table->decimal('overtime_billrate', 10, 2)->nullable()->default(0);
            $table->decimal('total_overtime_billrate', 10, 2)->nullable()->default(0);
            $table->decimal('doubletime_billrate', 10, 2)->nullable()->default(0);
            $table->decimal('total_doubletime_billrate', 10, 2)->nullable()->default(0);
            $table->decimal('total_billrate', 10, 2)->nullable()->default(0);
            $table->decimal('new_totall_billrate', 10, 2)->nullable()->default(0);
            $table->decimal('overtime_markup', 10, 2)->nullable()->default(0);
            $table->decimal('doubletime_markup', 10, 2)->nullable()->default(0);
            $table->decimal('total_markup', 10, 2)->nullable()->default(0);
            ...
            $table->boolean('cronjob_email_status')->nullable()->default(0);
            ...
            $table->integer('rate_type_for_modified')->nullable()->default(0);
            $table->integer('rejected_child')->nullable()->default(0);
            $table->enum('timesheet_current_type', ['Original', 'Modified', 'Modified Original']);
            $table->integer('timesheet_current_reverse')->nullable()->default(0);
